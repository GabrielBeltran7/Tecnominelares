    ...
    <div className={styles.formContainer}>
      ...
      <form className={styles.form} onSubmit={onSubmitInput}>
        <div className={styles.formGroup}>
          <div className={styles.labelGroup}></div>
        ...
        <div className={styles.formGroup}>
          ...
          >
            ...
            <option value="DESCAPOTAJE">
              Productos de excavacion y sobrantes de la adecuación de terrenos
            </option>
            <option value="EXCAVACION">
              Productos de cimentaciones y pilotaje: arcillas, bentonitas y
              demas
            </option>
